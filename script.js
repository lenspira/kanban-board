...
function getSavedColumns() {
  if (localStorage.getItem("backlogItems")) {
    ...
    backlogListArray = ["Deploy web app to GitHub", "Share link to web app on LinkedIn"];
    progressListArray = ["Test web app", "Write API documentation"];
    completeListArray = ["Design web app", "Develop web app"];
    onHoldListArray = ["Read developer blog"];
  }
}
